...
export default function EditProductDialog({ product, children }: EditProductDialogProps) {
  ...
  const form = useForm<ProductFormValues>({
    ...
    defaultValues: {
        ...
        technicalSheet: {
            material: product.technicalSheet?.material || '',
            colors: product.technicalSheet?.colors || '',
            grammage: product.technicalSheet?.grammage || '',
            mass: product.technicalSheet?.mass || '',
            bleedSize: product.technicalSheet?.bleedSize || '',
            finalSize: product.technicalSheet?.finalSize || '',
            ennoblement: product.technicalSheet?.ennoblement || '',
            finishing: product.technicalSheet?.finishing || '',
            productionTime: product.technicalSheet?.productionTime || '',
        },
